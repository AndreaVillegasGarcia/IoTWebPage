    ...
    <body>
        ...
        <div class='database'>
            <?php
    			...
    			$sql = "SELECT * FROM measures WHERE sensor='$id'";   
    			echo "<h2 class='sectionTitle'>Measurements of sensor ". $id . "</h2>";
    			...
    			if ($result->num_rows > 0) {
                    echo "<table class='tabla'>";
                        echo "<tr class='firstRow'>";
                            echo "<th>Id</td>";
                            echo "<th>Measurement value</td>";
                            echo "<th>Measurement date</td>";
                        echo "</tr>";
                        // output data of each row
                        while($row = $result->fetch_assoc()) {
                        	echo "<tr class='row'>";
    			             	echo "<td>" . $row["id"] . "</td>";
                             	echo "<td>" . $row["measure_value"] . "</td>";
